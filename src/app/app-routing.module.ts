...
const appRoutes: Routes = [
  ...
  // { path : "laptopNav", component : LaptopNavComponent,children:[{path:"lenovo",component:LenovoComponent},{path:"dell",component:DellComponent},{path:"hp",component:HpComponent}]},
